        ...
        while current_tick <= self._end_tick:
            ...
            if self.prices[current_tick] < self.prices[current_tick - 1]:
                while (current_tick <= self._end_tick and
                       self.prices[current_tick] < self.prices[current_tick - 1]): #price is decreasing , I pessimestic and predict it is going down
                    current_tick += 1
                position = Positions.Short
            else:
                while (current_tick <= self._end_tick and
                       self.prices[current_tick] >= self.prices[current_tick - 1]): #price is increasing or same , I optimistic and predict it will rise
                    current_tick += 1
